...
static const char* vShaderVerdeOs = "shaders/shaderVerdeOs.vert";
...
void CreateShaders()// Se crean los shaders 
{
	...
	shader5->CreateFromFiles(vShaderVerdeOs, fShader);
...
int main()
{
	...
	glm::mat4 projection = glm::ortho(-2.0f, 2.0f, -2.5f, 1.0f, 0.1f, 100.0f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		meshList[1]->RenderMesh();
			// piramide azul
		model = glm::mat4(1.0);//Se reestablece la matriz 
		...
		//angulo += 0.1;
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.3f, -1.3f, -2.0f));
		...
		//angulo += 0.1;
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.0f, -1.85f, -3.0f));
