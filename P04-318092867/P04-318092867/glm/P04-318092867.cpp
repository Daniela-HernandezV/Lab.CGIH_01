...
int main()
{
	...
	CrearCono(10, 2.0f);//índice 3 en MeshList
	...
	*/
	...
	/*
		...
		// en este caso no dibujaremos esferas que los representen		
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));	//Gira sbre el propio eje
		
		modelaux = model;	// cambia de matriz
		...
		model = modelaux;	// cambia de matriz
		...
		//articulación 4 unida a canasta
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(1.0f, 2.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		*/
		...
		//ARTICULACION PATA 1
		model = glm::translate(model, glm::vec3(8.0f, -6.0f, -4.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux3 = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//RODILLA 1
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, -0.2f));
		...
		//ARTICULACION PATA 3
		model = glm::translate(model, glm::vec3(2.0f, -4.0f, -2.5f));
