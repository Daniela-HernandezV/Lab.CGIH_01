...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux(1.0);//Inicializar matriz de Modelo 4x4 esta es auxiliar para heredar
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);	//reset con matriz identidad
		//rotación alrededor de la articulación que une con la cabina

		model = glm::translate(model, glm::vec3(0.0f, 6.0f, -4.0f));	// si esta separado se mueve independientemente
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(5.0f, 1.0f, 1.0f));

		//esfera de articulacion
